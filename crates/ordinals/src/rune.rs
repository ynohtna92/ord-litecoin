...
impl Rune {
  ...
  pub fn first_rune_height(network: Network) -> u32 {
    match network {
      ...
      Network::Regtest => 0,
      Network::Signet => 0,
      Network::Testnet => SUBSIDY_HALVING_INTERVAL * 3,
      _ => 0,
    }
  }
...
mod tests {
  ...
  fn minimum_at_height() {
    ...
    case(Network::Signet, 0, "ZZZTMGXWFSYU");
    case(Network::Signet, 1, "ZZZMYNVSLLXN");

    case(Network::Regtest, 0, "ZZZTMGXWFSYU");
    case(Network::Regtest, 1, "ZZZMYNVSLLXN");
  }
