...
mod tests {
  ...
  fn search_by_rune_id_returns_rune() {
    ...
    let rune = Rune(u128::from(84_000_000 * COIN_VALUE));
    ...
    server.assert_redirect("/search/2/1", "/rune/BGMBQKRCWLOC");
    server.assert_redirect("/search?query=2/1", "/rune/BGMBQKRCWLOC");
    ...
    let txid = server.bitcoin_rpc_server.broadcast_tx(TransactionTemplate {
      ...
      op_return: Some(
        Runestone {
          ...
          etching: Some(Etching {
            rune: Rune(u128::from(84_000_000 * COIN_VALUE)),
            ..Default::default()
          }),
          ..Default::default()
        }
...
<h1>Runes</h1>
<ul>
  <li><a href=/rune/BGMBQKRCWLOC>BGMBQKRCWLOC</a></li>
</ul>.*",
    );
  }
  ...
  fn runes_are_displayed_on_rune_page() {
    ...
    server.assert_response_regex(
      ...
      StatusCode::OK,
      format!(
        r".*<title>Rune BGMBQKRCWLOC</title>.*
<h1>Rune BGMBQKRCWLOC</h1>
<dl>
  <dt>id</dt>
  <dd>2/1</dd>
  <dt>supply</dt>
...
<dl>
  ...
  <dd>
    <table>
      ...
      <tr>
        <td><a href=/rune/BGMBQKRCWLOC>BGMBQKRCWLOC</a></td>
