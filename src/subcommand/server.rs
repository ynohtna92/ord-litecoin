...
<dl>
  ...
  fn sat_out_of_range() {
    TestServer::new().assert_response(
      ...
      StatusCode::BAD_REQUEST,
      "Invalid URL: failed to parse sat `8399999990760000`: invalid integer range",
    );
  }
...
",
  ...
  fn inscription_page_has_sat_when_sats_are_tracked() {
    ...
    server.assert_response_regex(
      format!("/inscription/{}", InscriptionId { txid, index: 0 }),
      StatusCode::OK,
      r".*<dt>sat</dt>\s*<dd><a href=/sat/5000000000>5000000000</a></dd>\s*<dt>sat name</dt>\s*<dd><a href=/sat/bgmbpulndxfd>bgmbpulndxfd</a></dd>\s*<dt>preview</dt>.*",
    );
  }
  ...
  fn block_info() {
    ...
    pretty_assert_eq!(
      ...
      api::BlockInfo {
        ...
        confirmations: 0,
        difficulty: 0.0,
        hash: "289e060d550847e8460ccd447d2253a0848cc0c12a5e3463b978ca30d3d038d6"
          .parse()
          .unwrap(),
        feerate_percentiles: [0, 0, 0, 0, 0],
        height: 1,
