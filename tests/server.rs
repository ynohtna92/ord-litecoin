...
fn inscription_page_after_send() {
  ...
  ord.assert_response_regex(
    format!("/inscription/{inscription}"),
    format!(
      r".*<h1>Inscription 0</h1>.*<dt>address</dt>\s*<dd class=monospace><a href=/address/ltc1qcqgs2pps4u4yedfyl5pysdjjncs8et5u0vraeu>ltc1qcqgs2pps4u4yedfyl5pysdjjncs8et5u0vraeu</a></dd>.*<dt>location</dt>\s*<dd class=monospace>{txid}:0:0</dd>.*",
    ),
  )
}
...
fn all_endpoints_in_recursive_directory_return_json() {
  ...
  assert_eq!(
    ...
    "dd814654c6e0aa64de58823725a6645920ddd32750ce560a879dd160fa76200c"
  );
