...
fn inscription_page_after_send() {
  ...
  ord_server.assert_response_regex(
    format!("/inscription/{inscription}"),
    format!(
      r".*<h1>Inscription 0</h1>.*<dt>address</dt>\s*<dd class=monospace>ltc1qcqgs2pps4u4yedfyl5pysdjjncs8et5u0vraeu</dd>.*<dt>location</dt>\s*<dd class=monospace>{txid}:0:0</dd>.*",
    ),
  )
}
